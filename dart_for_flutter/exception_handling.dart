...
// 1. ON Clause -- if you know the exception error
// 2. Catch Clause with Exception Object
// 3. Catch Clause with Exception Object and StackTrace Object
// 4. Finally Clause  --- ALWAYS EXECUTED IF THE STATEMENT IS VALID OR NOT
...
void main() {
  ...
  } on IntegerDivisionByZeroException { // -- if you know the exception
  ...
  print(''); print('CASE 5');               // CASE 5: Custom Exception
  try {
    depositMoney(-200);
  } catch (e) {
